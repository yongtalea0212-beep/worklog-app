  ...
  return (
    <Page size="A4" style={S.coverPage}>
      ...
      <View style={S.coverHeader}>
        ...
        <Text style={S.coverSub}>สรุปผลงานประจำเดือน · สร้างโดย StayScape</Text>
      ...
      <View style={[S.footer, { borderTopColor: 'rgba(255,255,255,0.2)' }]}>
        ...
        <Text style={S.footerBrand}>✦ StayScape</Text>
  ...
  return (
    <Page size="A4" style={S.page}>
      ...
      <View style={S.footer} fixed>
        <Text style={S.footerTxt}>StayScape · รายการงาน</Text>
        <Text style={S.footerBrand}>✦ StayScape</Text>
        <Text
          style={S.footerTxt}
    ...
    <Page size="A4" style={S.page}>
      ...
      <View style={S.noteBox}>
        ...
        <Text style={S.noteText}>
          รายงานนี้สร้างโดย StayScape อัตโนมัติ{'\n'}
      ...
      <View style={S.footer} fixed>
        <Text style={S.footerTxt}>StayScape · AI Analysis</Text>
        <Text style={S.footerBrand}>✦ StayScape</Text>
        <Text
          style={S.footerTxt}
          render={({ pageNumber, totalPages }) => `Page ${pageNumber} / ${totalPages}`}
...
export function ReportPDFDocument({ logs, aiReport = '' }) {
  ...
  return (
    <Document
      title={`StayScape · ${monthLabel}`}
      author="StayScape"
      subject="Monthly Work Report"
      creator="StayScape Platform"
    >
...
export async function downloadReportPDF(logs, aiReport = '') {
  ...
  a.download = `StayScape-Report-${month}.pdf`
